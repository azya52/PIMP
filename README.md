...
Если модуль отформатировался нормально и на него скопирован какой-либо образ, можно подключать его к МК-90 по указанной выше схеме. Cхема относительно простая но не очень правильная :) из-за инжекции дополнительного тока в источник питания Pico. Плюс к этой проблеме есть еще одна - МК-90 не любит нагрузку при выключенном питании (а при лучшем варианте Pico потребляет ~700мкА) поэтому, при разряженных батарейках, с подлюченным PIMP, МК-90 может не запускаться. Пользуемся на свой страх и риск, чуть позже опубликую более сложный, но правильный вариант.
